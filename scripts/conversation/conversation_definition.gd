...
@export var humility_drain: int = 3
...
@export var patience_drain: int = 3
...
func get_dialogue_set() -> NPCDialogueSet:
    return dialogue.create_instance()
